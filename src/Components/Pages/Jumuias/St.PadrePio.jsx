    ...
    <div>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">
            St <span style={{ color: "#ffeb3b" }}>Padre Pio</span>
          </h1>
          <p className="lead mt-3 text-center">
            St. Padre Pio Jumuia is devoted to prayer, healing, and confession.
          </p>
          <a
            href="/contact"
            className="btn"
      ...
      <section className="container my-5">
        <h2 className="fw-bold mb-4" style={{ color: "#6f4e37" }}>
          About St. Padre Pio Jumuia
        </h2>
        <p className="text-muted fs-5">
          St. Padre Pio Jumuia emphasizes strong devotion to the Eucharist, confession, and healing 
          ministries inspired by the life of Padre Pio.
        </p>
      </section>
      ...
      <section className="container my-5">
        ...
        <div className="row g-4">
          {[
            {
              title: "Healing Mass",
              desc: "A healing Mass invoking intercession of St. Padre Pio.",
              date: "October 30, 2025",
              img: "https://via.placeholder.com/400x200",
            },
            {
              title: "Confession Day",
              desc: "A day dedicated to reconciliation and confession, inspired by Padre Pio’s ministry.",
