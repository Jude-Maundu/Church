    ...
    <div>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">
            St <span style={{ color: "#ffeb3b" }}>Jude</span>
          </h1>
          <p className="lead mt-3 text-center">
            St. Jude Jumuia stands as a place of hope and perseverance for difficult causes.
          </p>
          <a
            href="/contact"
            className="btn"
      ...
      <section className="container my-5">
        <h2 className="fw-bold mb-4" style={{ color: "#6f4e37" }}>
          About St. Jude Jumuia
        </h2>
        <p className="text-muted fs-5">
          St. Jude Jumuia focuses on prayers for hopeless cases, intercessions, and community solidarity for the suffering.
        </p>
      </section>
          ...
          {[
            {
              ...
              desc: "Nine days of prayer for difficult and urgent causes.",
              date: "October 20–28, 2025",
              img: "https://via.placeholder.com/400x200",
            },
            {
              title: "Hope Outreach",
              desc: "Visiting struggling families with prayer and support.",
