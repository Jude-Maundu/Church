    ...
    <div>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">
            St <span style={{ color: "#ffeb3b" }}>Mary</span>
          </h1>
          <p className="lead mt-3 text-center">
            St. Mary Jumuias focus on Marian devotion, intercessory prayer, and compassionate care.
          </p>
          <a
            href="/contact"
            className="btn"
      ...
      <section className="container my-5">
        <h2 className="fw-bold mb-4" style={{ color: "#6f4e37" }}>
          About St. Mary Jumuias
        </h2>
        <p className="text-muted fs-5">
          St. Mary Jumuias gather for Marian prayers, rosary groups, and ministries focused on mercy and pastoral care.
        </p>
      </section>
      ...
      <section className="container my-5">
        ...
        <div className="row g-4">
          {[
            {
              title: "Marian Rosary Evening",
              desc: "A monthly rosary evening devoted to Our Lady.",
              date: "Every 3rd Wednesday",
              img: "https://via.placeholder.com/400x200",
            },
            {
              title: "Comfort Ministry Visit",
              desc: "Home visits and prayers for the sick and elderly.",
