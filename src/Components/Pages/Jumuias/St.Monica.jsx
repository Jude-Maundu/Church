    ...
    <div>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">
            St <span style={{ color: "#ffeb3b" }}>Monica</span>
          </h1>
          <p className="lead mt-3 text-center">
            St. Monica Jumuia is dedicated to prayerful perseverance and family unity.
          </p>
          <a
            href="/contact"
            className="btn"
      ...
      <section className="container my-5">
        <h2 className="fw-bold mb-4" style={{ color: "#6f4e37" }}>
          About St. Monica Jumuia
        </h2>
        <p className="text-muted fs-5">
          St. Monica Jumuia prays for families, children, and perseverance in faith, inspired by the example of St. Monica.
        </p>
      </section>
          ...
          {[
            {
              ...
              desc: "Evening of prayers dedicated to family unity.",
              date: "October 15, 2025",
              img: "https://via.placeholder.com/400x200",
            },
            {
              title: "Youth Intercession",
              desc: "Special prayers for children and youth guidance.",
