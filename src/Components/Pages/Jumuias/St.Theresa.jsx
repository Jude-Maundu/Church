    ...
    <div>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">
            St <span style={{ color: "#ffeb3b" }}>Theresa</span>
          </h1>
          <p className="lead mt-3 text-center">
            St. Theresa Jumuia follows the Little Way of love, humility, and service.
          </p>
          <a
            href="/contact"
            className="btn"
      ...
      <section className="container my-5">
        <h2 className="fw-bold mb-4" style={{ color: "#6f4e37" }}>
          About St. Theresa Jumuia
        </h2>
        <p className="text-muted fs-5">
          Inspired by St. Thérèse of Lisieux, this Jumuia practices simple acts of love, devotion, and
          prayer, living out holiness in daily life.
        </p>
      </section>
      ...
      <section className="container my-5">
        ...
        <div className="row g-4">
          {[
            {
              title: "Little Way Retreat",
              desc: "A day retreat focusing on St. Theresa’s spirituality of love and humility.",
              date: "October 25, 2025",
              img: "https://via.placeholder.com/400x200",
            },
            {
              title: "Flower Offering Mass",
              desc: "A special Mass with floral devotion to honor St. Theresa.",
