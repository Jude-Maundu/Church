    ...
    <div>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">
            St <span style={{ color: "#ffeb3b" }}>Josemaria</span>
          </h1>
          <p className="lead mt-3 text-center">
            Inspired by St. Josemaria Escriva, this Jumuia emphasizes sanctity in daily work and prayer.
          </p>
          <a
            href="/contact"
            className="btn"
      ...
      <section className="container my-5">
        <h2 className="fw-bold mb-4" style={{ color: "#6f4e37" }}>
          About St. Josemaria Jumuia
        </h2>
        <p className="text-muted fs-5">
          St. Josemaria Jumuia gathers professionals, students, and families to live holiness in daily life through prayer and service.
        </p>
      </section>
      ...
      <section className="container my-5">
        ...
        <div className="row g-4">
          {[
            {
              title: "Work & Holiness Seminar",
              desc: "A workshop on finding God in ordinary work.",
              date: "October 5, 2025",
              img: "https://via.placeholder.com/400x200",
            },
            {
              title: "Family Prayer Night",
              desc: "An evening of prayer and sharing for families.",
